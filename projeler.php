...
<section class="page-head">
  <div class="container">
    <h1>Hizmet Verdiğimiz Sektörler</h1>
    <nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/">Anasayfa</a></li><li class="breadcrumb-item active">Sektörler</li></ol></nav>
  </div>
</section>
...
<section>
  <div class="container">
    <div class="section-head">
      <span class="badge-mini">Uzmanlık Alanlarımız</span>
      <h2>Her Sektörün <span>Muhasebesi Başka</span></h2>
    </div>
