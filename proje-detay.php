...
<section class="page-head">
  <div class="container">
    <h1><?= e($p['baslik']) ?></h1>
    <nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/">Anasayfa</a></li><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/projeler">Sektörler</a></li><li class="breadcrumb-item active"><?= e($p['baslik']) ?></li></ol></nav>
  </div>
</section>
<section>
  <div class="container">
