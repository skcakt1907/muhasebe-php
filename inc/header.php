  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link <?= in_array($current,['projeler.php','proje-detay.php'])?'active':'' ?>" href="<?= SITE_URL ?>/projeler">Sektörler</a></li>
        <li class="nav-item"><a class="nav-link <?= in_array($current,['blog.php','blog-detay.php'])?'active':'' ?>" href="<?= SITE_URL ?>/blog">Mali Rehber</a></li>
