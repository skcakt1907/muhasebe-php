...
<section>
  <div class="container">
    <div class="section-head center">
      ...
      <p>Kuruluştan beyana, bordrodan teşvike — işletmenizin tüm mali ihtiyaçları tek çatı altında.</p>
    </div>
    <div class="row g-4">
...
<section class="cta">
  <div class="container d-flex justify-content-between align-items-center flex-wrap">
    <h3>İşletmenize özel teklif için ücretsiz ön görüşme</h3>
    <a href="<?= SITE_URL ?>/teklif" class="btn">Teklif Al</a>
  </div>
</section>
