...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    if(!$f['ad'] || !$f['tel'] || !$f['hizmet']){
        ...
        $stmt->execute($f);
        $mesaj = 'Teklif talebiniz alındı. Müşavirlerimiz en kısa sürede sizi arayıp ücretsiz ön görüşmenizi planlayacak.';
    }
}
...
<section>
  <div class="container">
    <div class="row g-5">
      <div class="col-lg-7">
        <span class="badge-mini">Ücretsiz Ön Görüşme</span>
        <h2>İşletmeniz İçin <span style="color:var(--primary)">Teklif</span> Alın</h2>
        <p class="text-muted mb-4">Formu doldurun, müşavirlerimiz sizi arasın; işletmenizin yapısına göre ücretsiz ön görüşme yapıp size özel teklif hazırlayalım.</p>
        ...
        <form method="post" class="contact-form">
          ...
          <h5 class="mb-3 mt-4" style="color:var(--primary)"><i class="bi bi-briefcase me-2"></i>İşletme Bilgileri</h5>
          <div class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-md-4"><label class="form-label">Çalışan Sayısı</label><input class="form-control" name="alan" placeholder="örn. 5"></div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              ...
              <select class="form-select" name="baslangic">
                ...
                <option>Yeni dönem başında</option>
                <option>Sadece bilgi alıyorum</option>
              </select>
            </div>
            <div class="col-12"><label class="form-label">Notlarınız</label><textarea class="form-control" name="detay" rows="5" placeholder="Faaliyet alanınız, aylık belge hacminiz, mevcut müşavirinizden ayrılma nedeniniz..."></textarea></div>
      ...
      <div class="col-lg-5">
        ...
        <ul class="quote-perks">
          <li><i class="bi bi-clipboard2-check"></i><div><strong>Ücretsiz Ön Görüşme</strong><span>Mali düzeninizi birlikte inceliyoruz.</span></div></li>
