...
<section class="page-head">
  <div class="container">
    <h1><?= e($b['baslik']) ?></h1>
    <nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/">Anasayfa</a></li><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/blog">Mali Rehber</a></li><li class="breadcrumb-item active"><?= e($b['baslik']) ?></li></ol></nav>
  </div>
</section>
<section>
  <div class="container">
